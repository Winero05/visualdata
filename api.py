...
def get_dataframe_from_file(file: UploadFile):
    """Charge un DataFrame depuis un UploadFile en mémoire."""
...
def get_data_source(
    ...
    """Dépendance pour centraliser la logique de chargement des données."""
...
def get_image_visualizer(
    ...
    """Dépendance pour charger une image et retourner une instance d'ImageVisualizer."""
...
def visualiser_tabulaire(
    ...
    elif type_graphique == "correlations":
    ...
    # On choisit la première (heatmap) qui est la plus commune.
    fig = figures[0]
...
# Exemple de concept pour un endpoint unifié
