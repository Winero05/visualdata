...
class TextVisualizer:
    ...
    def word_length_hist(self, return_fig: bool = False):
    ...
    def sentence_length_hist(self, return_fig: bool = False):
    ...
    def most_common_words(self, top_n=20, return_fig: bool = False):
    ...
    def generate_wordcloud(self, max_words=200, return_fig: bool = False):
        """Nuage de mots"""
    ...
    def bigram_analysis(self, top_n=20, return_fig: bool = False):
